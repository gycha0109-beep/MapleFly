...
const L2 = 0.0005;
const THRESHOLD = 0.5;
const ORDER_SEED = 1506000;
const LABEL_SHUFFLE_SEED = 1516000;
...
async function main() {
  ...
  const output = {
    meta: {
      schema:
        "maplefly.experiment-v11g2b.short-history-representation-screen.1",
      brainRepository:
        SOURCE.repository,
      brainCommit:
        SOURCE.commit,
