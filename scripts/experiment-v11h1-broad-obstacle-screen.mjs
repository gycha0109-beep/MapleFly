...
async function main() {
  ...
  const output = {
    meta: {
      schema:
        "maplefly.experiment-v11h1.broad-obstacle-context-separability.1",
      brainRepository:
        SOURCE.repository,
      brainCommit:
        SOURCE.commit,
      ...
      sensoryArchitecture: {
        ...
        obstacle:
          "equal fixed obstacle drive to LC6/LC16/LC12/LC15; obstacle LC4 disabled",
